window.__ModuleLoader__.load({
	...
	factory: (require) => {
		 ...
		 * profile in localStorage (`dsh.keys-palette.v1`).
		 */
		...
		const I18N = {
			zh: {
				...
				actOpenDetails: "打开详情栏",
				actOpenDetailsDesc: "以停靠模式打开右侧详情栏",
				actOpenDetailsFullscreen: "全屏打开详情栏",
				actOpenDetailsFullscreenDesc: "以全屏覆盖模式显示右侧详情栏",
				actCloseDetails: "关闭详情栏",
				actCloseDetailsDesc: "收起右侧详情栏",
				actNewSession: "新建会话",
			...
			en: {
				...
				actOpenDetails: "Open Details",
				actOpenDetailsDesc: "Open the right details bar in docked mode",
				actOpenDetailsFullscreen: "Open Details Fullscreen",
				actOpenDetailsFullscreenDesc: "Show the right details bar as a fullscreen overlay",
				actCloseDetails: "Close Details",
				actCloseDetailsDesc: "Collapse the right details bar",
...
`;
		...
		function builtinDefs(ctx) {
			return [
				...
				{ id: "open-details", labelKey: "actOpenDetails", descriptionKey: "actOpenDetailsDesc", run: () => { const s = ctx.get("layout"); if (s) s.openRightbar(true, false); } },
				{ id: "open-details-fullscreen", labelKey: "actOpenDetailsFullscreen", descriptionKey: "actOpenDetailsFullscreenDesc", run: () => { const s = ctx.get("layout"); if (s) s.openRightbar(false, true); } },
				{ id: "close-details", labelKey: "actCloseDetails", descriptionKey: "actCloseDetailsDesc", run: () => { const s = ctx.get("layout"); if (s) s.closeRightbar(); } },
		...
		function apply(ctx) {
			...
			// ================= store + persistence =================
			const STORAGE_KEY = "dsh.keys-palette.v1";
			const DEFAULTS = {
